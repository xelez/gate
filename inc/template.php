<?php
  ...
  if ($_template_included_ != '#template_Included#') {
    ...
    function tpl_set_args ($args) {
      global $tpl_args, $tpl_namespace_depth;
      $tpl_args[$tpl_namespace_depth] = $args;
    }

    function tpl_arg ($name) {
      global $tpl_args, $tpl_namespace_depth;
      return $tpl_args[$tpl_namespace_depth][$name];
    }

    function tpl_args () {
      global $tpl_args, $tpl_namespace_depth;
      return $tpl_args[$tpl_namespace_depth];
    }
    ...
    function tpl_eval ($src) {
      return eval_code ('<? global $pIFACE, $CORE; ?>'.$src);
    }
    ...
    function tpl_src_unparsed ($src, $vars = array ()) {
      return tpl_src ($src, $vars, false, false);
    }
    ...
    function tpl_unparsed ($src, $vars = array ()) {
      return tpl ($src, $vars, false, false);
    }

    function tpl_dir_relative () { return '/inc/templates'; }
    function tpl_dir () {
      global $DOCUMENT_ROOT;
      return $DOCUMENT_ROOT.tpl_dir_relative ();
    }
